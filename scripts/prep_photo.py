...
NOTE: this needs `rembg` (downloads a small ML model on first run) and
`opencv-python`. Run this on your own machine, not inside a restricted
sandbox with no general internet access -- rembg needs to fetch its model
the first time.
"""
import os
import sys
